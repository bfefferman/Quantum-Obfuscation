...
Following the classical approach of Goldwasser and Rothblum~\cite{GR07}, we define a version of \expref{Definition}{def:vbb-obfuscator} which guarantees indistinguishability of obfuscator outputs, by replacing condition (2.) with:
\begin{enumerate}
\setcounter{enumi}{1}
